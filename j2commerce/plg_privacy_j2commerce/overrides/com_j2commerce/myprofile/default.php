<?php
/**
 * J2Commerce 6 MyProfile — Main Tab View
 * Template override for plg_privacy_j2commerce
 *
 * Adds a "Privacy" tab to the J2Commerce 6 myprofile view.
 * Based on com_j2commerce/tmpl/myprofile/bootstrap5/default.php.
 *
 * WHY THIS OVERRIDE IS NEEDED
 * J2Commerce's pluginTabHtml only includes plugins in the 'j2store' group.
 ...
 *   templates/{active-template}/html/com_j2commerce/myprofile/default.php
...
<div class="j2commerce">
    ...
    <div class="j2commerce-myprofile">
        ...
        <ul class="nav nav-tabs d-flex justify-content-center border-0 rounded-0 bg-transparent" id="j2commerceProfileTabs" role="tablist">
            ...
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="<?php echo $_privacyTabId; ?>-btn" data-bs-toggle="tab"
                    data-bs-target="#<?php echo $_privacyTabId; ?>-pane" type="button" role="tab"
                    aria-controls="<?php echo $_privacyTabId; ?>-pane" aria-selected="false">
                    <span class="fa-solid fa-shield me-1" aria-hidden="true"></span>
                    <?php echo Text::_('PLG_PRIVACY_J2COMMERCE_MYPROFILE_TAB_TITLE'); ?>
                </button>
            </li>
            <?php endif; ?>
        ...
        <div class="tab-content pt-4 px-0 border-0 box-shadow-none" id="j2commerceProfileTabContent">
            ...
            <?php if ($_privacyEnabled): ?>
            <div class="tab-pane fade" id="<?php echo $_privacyTabId; ?>-pane" role="tabpanel" aria-labelledby="<?php echo $_privacyTabId; ?>-btn">
