 ...
 *   templates/{active-template}/html/com_j2store/myprofile/default_privacy.php
...
// Guest access is valid only with both session values J2Store sets for guest orders.
$_guestEmail = $_userId === 0 ? (string) $_session->get('guest_order_email', '', 'j2store') : '';
$_isGuest    = $_guestEmail !== '' && (string) $_session->get('guest_order_token', '', 'j2store') !== '';
